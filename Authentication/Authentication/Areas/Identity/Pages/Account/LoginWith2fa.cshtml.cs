...
namespace Authentication.Areas.Identity.Pages.Account
{
    ...
    public class LoginWith2faModel : PageModel
    {
        ...
        public LoginWith2faModel(SignInManager<AuthenticationUser> signInManager, ILogger<LoginWith2faModel> logger)
        {
        ...
        public class InputModel
        {
            ...
            [StringLength(7, ErrorMessage = "Doğrulama kodu en az 6 karakterden oluşmalıdır ve sadece rakam içermelidir!", MinimumLength = 6)]
            [DataType(DataType.Text)]
            [Display(Name = "Güvenlik kodu")]
            public string TwoFactorCode { get; set; }

            [Display(Name = "Bu makinede hatırla")]
