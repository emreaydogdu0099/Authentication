...
namespace Authentication.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "Şifreniz en az 6 karakter olmalı ve en az 1 harf ve rakam içermelidir.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AuthenticationUser { UserName = Input.Email, Email = Input.Email, FirstName = Input.FirstName, LastName = Input.LastName };
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "E-postanızı onaylayın",
                        $"Lütfen buraya <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>tıklayarak hesabınızı onaylayın</a>.");
